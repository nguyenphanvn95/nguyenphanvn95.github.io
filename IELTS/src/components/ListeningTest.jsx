...
import { Clock, Flag, HelpCircle, X, ChevronLeft, ChevronRight, Play, Pause, Volume2 } from 'lucide-react';

function ListeningTest({ test, onFinish, onExit }) {
      ...
      <div>
        <div className="test-header">
          <div className="test-header-left">
            <div className="test-module-title">IELTS Listening - Review</div>
          </div>
  ...
  return (
    <div>
      <div className="test-header">
        <div className="test-header-left">
          <div className="test-module-title">IELTS Listening</div>
      ...
      <div className="test-content">
        <div className="test-main">
          <div className="test-questions-panel" style={{ flex: '1', borderRight: 'none' }}>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                <Volume2 size={24} color="var(--bc-blue)" />
                <div style={{ fontWeight: 600, color: 'var(--bc-navy)' }}>
                  {section.title}
                </div>
              </div>
              ...
              {section.audioUrl ? (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ 
                        ...
                        <span>{formatTime(Math.floor(audioTime))}</span>
                ...
                <div style={{ 
                  ...
                  ⚠️ {section.audioNote || 'No audio file provided. Please upload audio for this section.'}
                </div>
              )}
            </div>
